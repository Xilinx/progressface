...
class OHEGroupSamplingOperator(mx.operator.CustomOp):
    def __init__(self, stride=0, network='', dataset='', prefix=''):
        super(OHEGroupSamplingOperator, self).__init__()
...
class OHEGroupSamplingProp(mx.operator.CustomOpProp):
    def __init__(self, stride=0, network='', dataset='', prefix=''):
        super(OHEGroupSamplingProp, self).__init__(need_top_grad=False)
        self.stride = stride
    ...
    def create_operator(self, ctx, shapes, dtypes):
        return OHEGroupSamplingOperator(self.stride, self.network, self.dataset, self.prefix)
