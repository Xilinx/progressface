...
def residual_unit(data, num_filter, ratio, stride, dim_match, name, bottle_neck=True, bn_mom=0.9, workspace=512,
                  memonger=False):
...
def resnet(units, num_stage, filter_list, ratio_list, num_class, data_type, bottle_neck=True, bn_mom=0.9, workspace=512,
           memonger=False):
